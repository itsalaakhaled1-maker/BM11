export const metadata = {
  title: "سياسة الاسترداد | مُفكِر",
  description: "سياسة الاسترداد وإرجاع الأموال لموقع مُفكِر",
};
        ...
        <div className="space-y-8">
          <section>
            ...
            <p className="text-slate-600 leading-relaxed">
              نسعى في شركة حكيم لتقديم أفضل تجربة ممكنة لمستخدمي مُفكِر. نفهم أن الظروف قد تتغير، لذلك وضعنا هذه السياسة لتوضيح شروط وإجراءات استرداد الأموال. بشراءك لأي اشتراك مدفوع، فإنك توافق على بنود هذه السياسة.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-slate-900 mb-3">2. فترة التجربة المجانية</h2>
            ...
            <ul className="list-disc list-inside space-y-1 text-slate-600">
              <li>يمكنك استكشاف جميع الميزات المتاحة في خطتك.</li>
          ...
          <section>
            <h2 className="text-xl font-bold text-slate-900 mb-3">3. شروط الاسترداد</h2>
            <p className="text-slate-600 leading-relaxed mb-2">
              يحق لك طلب استرداد كامل المبلغ في الحالات التالية:
            </p>
            
            <div className="bg-green-50 border border-green-200 rounded-xl p-4 mb-4">
              <h3 className="font-bold text-green-800 mb-2">✅ يتم الموافقة على الاسترداد:</h3>
              <ul className="list-disc list-inside space-y-1 text-green-700">
                ...
                <li>لم تستخدم الخدمة بشكل جوهري (أقل من 3 أبحاث مُنشأة).</li>
              </ul>
            </div>

            <div className="bg-red-50 border border-red-200 rounded-xl p-4">
              <h3 className="font-bold text-red-800 mb-2">❌ لا يتم الاسترداد في الحالات التالية:</h3>
              <ul className="list-disc list-inside space-y-1 text-red-700">
                <li>مرور أكثر من 14 يوماً على تاريخ الشراء.</li>
                <li>استخدامك لأكثر من 50% من الميزات المتاحة في خطتك.</li>
                <li>إنشاء أكثر من 10 أبحاث عبر النظام.</li>
          ...
          <section>
            <h2 className="text-xl font-bold text-slate-900 mb-3">4. كيفية طلب الاسترداد</h2>
            <p className="text-slate-600 leading-relaxed mb-2">
            ...
            <ol className="list-decimal list-inside space-y-2 text-slate-600">
              ...
              <li>اكتب في الموضوع: &quot;طلب استرداد — [رقم الطلب أو البريد الإلكتروني]&quot;.</li>
          ...
          <section>
            <h2 className="text-xl font-bold text-slate-900 mb-3">5. مدة استعادة الأموال</h2>
            <p className="text-slate-600 leading-relaxed mb-2">
          ...
          <section>
            <h2 className="text-xl font-bold text-slate-900 mb-3">6. الاسترداد الجزئي</h2>
            <p className="text-slate-600 leading-relaxed mb-2">
          ...
          <section>
            <h2 className="text-xl font-bold text-slate-900 mb-3">7. تغيير الخطة</h2>
            <p className="text-slate-600 leading-relaxed mb-2">
          ...
          <section>
            <h2 className="text-xl font-bold text-slate-900 mb-3">8. الاستثناءات الخاصة</h2>
            <p className="text-slate-600 leading-relaxed mb-2">
            ...
            <ul className="list-disc list-inside space-y-1 text-slate-600">
              ...
              <li>ظروف قهرية (حرب، كوارث طبيعية، إغلاقات حكومية).</li>
              <li>قرار إداري استثنائي بناءً على مراجعة فردية.</li>
            </ul>
          </section>

          <section>
            <h2 className="text-xl font-bold text-slate-900 mb-3">9. إلغاء الاشتراك التلقائي</h2>
            <p className="text-slate-600 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-slate-900 mb-3">10. التواصل معنا</h2>
            <p className="text-slate-600 leading-relaxed mb-2">
            ...
            <div className="bg-slate-50 rounded-xl p-6 space-y-2 border border-slate-200">
              ...
              <p className="text-slate-600"><strong>وقت الاستجابة:</strong> 24-48 ساعة عمل</p>
