    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900">
      <div className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl p-8 max-w-md w-full mx-4 text-center">
        ...
        <button
          ...
          className="w-full bg-white hover:bg-blue-50 text-slate-900 font-semibold py-3 px-6 rounded-xl flex items-center justify-center gap-3 transition shadow-lg"
        >
